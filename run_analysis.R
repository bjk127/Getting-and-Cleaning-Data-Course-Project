...
[History restored from /Users/benjaminkinsella/.Rapp.history]
...
100 59.6M  100 59.6M    0     0   674k      0  0:01:30  0:01:30 --:--:--  289k   0    0     0      0      0 --:--:-- --:--:-- --:--:--     0
> 
> # Unzip the file
> unzip(zipfile="./data/Dataset.zip",exdir="./data")
> 
> #3 Unzipped file are in the folder UCI HAR Dataset. Get the list of files.
...
[67] "subject"                                        "activity"                                      
> 
# From the data set in step 4, create a second, independent tidy data set with the average of each variable for each variable and activity and each subject.
> library(plyr)
